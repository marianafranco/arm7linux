...
Pensando em como aproximar essas duas disciplinas, surgiu a idéia de desenvolver uma ferramenta didática que unisse um \emph{hardware} e sistema operacional de estudo simples, e que pudesse ser utilizada nas experiências do Laboratório de Processadores.
