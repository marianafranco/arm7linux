...
A fim de se facilitar a programação e o entendimento do projeto, foram criadas duas estruturas de dados que são acessadas em \emph{assembly}. A primeira, o Process Control Block é responsável pelo armazenamento do estado de uma \emph{thread}. Já a Lista de Threads realiza o controle de quais \emph{threads} estão ativas.
