...
O editor de linha de comando do KinOS possui três funcionalidades básicas: listar \emph{threads} ativas (\emph{ps}), inicializar novas \emph{threads} (\emph{start}) e encerrar \emph{threads} ativas (\emph{end}). As sintaxes de cada comando são, respectivamente:
